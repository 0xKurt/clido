# Definition of Done: v4 (detailed)

Generated from `v4-dod.yaml`. Source plan: `v4.md`. Do not edit this file by hand; run `scripts/generate-dod-md.sh v4` to regenerate.

Verify with: `scripts/verify-dod.sh` (set CURRENT to v4 first).
