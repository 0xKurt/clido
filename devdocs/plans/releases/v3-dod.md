# Definition of Done: v3 (detailed)

Generated from `v3-dod.yaml`. Source plan: `v3.md`. Do not edit this file by hand; run `scripts/generate-dod-md.sh v3` to regenerate.

Verify with: `scripts/verify-dod.sh` (set CURRENT to v3 first).
